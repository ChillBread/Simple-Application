              ...
              embeds: [
                new MessageEmbed()
                  ...
                  .setFields([
                    ...
                    {
                      name: "Credits",
                      value: "[Made by Ee3](https://github.com/ee3DevYT)",
                    },
                  ]),
              ],
              ephemeral: true,
            ...
            applyChannel.send({
              embeds: [
                new MessageEmbed()
                  ...
                  .setDescription(
                    "Click on the below apply button to fill the application form"
                  )
                  .setImage(
                    "https://cdn.discordapp.com/attachments/875081353572548609/980048040440262696/1653732040816.png"
                  )
                  .setFooter("you2PG multipurpose discord bot coming soon!"),
              ],
              components: [btnrow],
            });
